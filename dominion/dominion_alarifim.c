...
//
// Refactoring cards: Adventurer, council_room, steward, salvenger, embargo//
//
int AdventurerCard(struct gameState *state, int temphand[], int z, int drawntreasure, int currentPlayer)
{
...
void StewardCard(struct gameState *state, int choice1, int choice2, int choice3, int currentPlayer, int handPos)
{
      if (choice1 == 1)
	{
	  //+2 cards
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
       z = AdventurerCard(state, temphand, z, drawntreasure, currentPlayer);
       return 0;
...
//      }     
    ...
    case steward:
      StewardCard( state,  choice1,  choice2,  choice3,  currentPlayer,  handPos);
      return 0;
    ...
    case embargo: 
      EmbargoCard( state,  choice1,  currentPlayer, handPos);
      return 0;
    ...
    case salvager:
      SalvagerCard(state, choice1, currentPlayer, handPos);
      return 0;
